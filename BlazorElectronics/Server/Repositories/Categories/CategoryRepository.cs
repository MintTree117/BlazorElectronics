...
public class CategoryRepository : DapperRepository, ICategoryRepository
{
    ...
    public async Task<CategoriesModel?> Get()
    {
    ...
    static async Task<CategoriesModel?> GetCategoriesQuery( SqlConnection connection, string? dynamicSql, DynamicParameters? dynamicParams )
    {
        ...
        IEnumerable<CategoryModel>? primary = await multi.ReadAsync<CategoryModel>();
        IEnumerable<CategoryModel>? secondary = await multi.ReadAsync<CategoryModel>();
        IEnumerable<CategoryModel>? tertiary = await multi.ReadAsync<CategoryModel>();
